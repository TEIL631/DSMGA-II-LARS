...
CXXFLAGS = -O2 -Wall -march=native -std=c++11 -g
INCLUDE = 
TLIB = -lm
...
SRC1 = chromosome.cpp dsmga2.cpp fastcounting.cpp global.cpp main.cpp mt19937ar.cpp myrand.cpp spin.cpp nk-wa.cpp sat.cpp leading.cpp maxcut.cpp

SRC2 = chromosome.cpp dsmga2.cpp fastcounting.cpp global.cpp sweep.cpp mt19937ar.cpp myrand.cpp spin.cpp nk-wa.cpp sat.cpp leading.cpp maxcut.cpp
